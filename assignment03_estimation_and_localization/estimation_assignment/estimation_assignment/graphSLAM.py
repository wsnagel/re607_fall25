...
class LocalizationWithRangeMeasurements(object):
    ...
    def cost_function(self, x):
        ...
        # Here F is a vector of residuals, not a custom State class as we have defined
        F = np.array([])
        ...
        for t in range(1, T):
            ...
            # Remember: you have defined functions above to handle some of these calculations!
